...
@RunWith(Parameterized.class) abstract class ParameterisedTestBase {
     ...
     */
    static void assertTicketCount(@Nonnull Board.GameState game, @Nonnull Piece colour,
                                  int taxi,
                                  int bus,
                                  int underground,
                                  int x2,
    ...
    /**
     * Creates a new {@link Move.DoubleMove}
     *
